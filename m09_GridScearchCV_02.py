...
model = GridSearchCV(XGBRegressor(), parameters, cv = kfold, verbose=1,)           # Grid : 격자(모든 경우의 수를 다 해보겠다는 의미)
...
print("r2_score : ", r2_score(y_test, y_predict))  # 0.875 -? model.score와 동일
