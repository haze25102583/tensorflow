...
# model.save("./_save/keras22_3_save_model.keras")                  # 상대경로 방식
# model.save("c:/nsu_work/_save/keras22_3_save_model.keras")        # 절대경로 방식

model = load_model("c:/nsu_work/_save/keras22_3_save_model.keras")
model.summary()
# exit()
